...
public class DetailActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private CountingIdlingResource IdlingResource = null;
    ...
    public void onResponse(JSONObject response) {
        try {
            ...
            if (nodes.length() == 0) {
                ...
                WheelmapTask task = new WheelmapTask(IdlingResource);
    ...
    void setIdlingResource(CountingIdlingResource resource) {
